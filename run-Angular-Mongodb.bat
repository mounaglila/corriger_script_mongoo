@echo off
echo ===== Setting up Angular Frontend Mongodb =====
...
if not exist "%projectDir%" (
    ...
    echo  if ^(confirm^(`Are you sure you want to delete '${table}' ?`^)^) { >>src\app\admin\admin.component.ts
    ...
    echo       console.log^('Table deleted:', response^); >>src\app\admin\admin.component.ts
    ...
    echo       alert^(`Table ${table} Successfully deleted !`^); >>src\app\admin\admin.component.ts
    echo      }, >>src\app\admin\admin.component.ts
    echo      ^(error^) =^> { >>src\app\admin\admin.component.ts
    echo        console.error^('Error while deleting the table:', error^); >>src\app\admin\admin.component.ts
    echo        alert^(`Error while deleting the table:'${table}'`^); >>src\app\admin\admin.component.ts
    echo      } >>src\app\admin\admin.component.ts
    echo    ^); >>src\app\admin\admin.component.ts
    echo  }>>src\app\admin\admin.component.ts
    echo }>>src\app\admin\admin.component.ts
    ...
    for %%i in (%items%) do (
        ...
        echo       console.log^("Data received:", data ^); >> src\app\%%i\%%i.component.ts
        ...
        echo            // Update the data display after deletion >> src\app\%%i\%%i.component.ts
    ...
    :: Writing the index.html file with the generated components
